...
public class AnimalJoint : MonoBehaviour
{
    ...
    virtual public void AfterInstantiate(Vector3 _segPosition, Quaternion _segRotation, Vector3 _segScale, float _distanceConstraint, float _angularConstraint, int _id)
    {
    ...
    virtual public void AfterInstantiate(float _distanceConstraint, float _angularConstraint, int _id)
    {
